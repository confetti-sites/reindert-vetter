...
class ContentComponent extends ComponentStandard
{
    ...
    public function __toString(): string
    {
        ...
        return 'Error: Can not render to string. Include all blocks instead. Example: @include(\'pkg.confetti-cms.content.blocks.index\', [\'model\' => $contentRow->content(\'content\')])';
    }
